...
@interface YZGridViewFlowLayout () <UIGestureRecognizerDelegate>

@property (nonatomic,readonly) id<YZGridViewDataSource> dataSource;
@property (nonatomic,readonly) id<YZGridViewDelegateFlowLayout> delegate;

@end

@implementation YZGridViewFlowLayout
{
...
- (id<YZGridViewDataSource>)dataSource
{
    return (id<YZGridViewDataSource>)self.collectionView.dataSource;
}

- (id<YZGridViewDelegateFlowLayout>)delegate
{
    return (id<YZGridViewDelegateFlowLayout>)self.collectionView.delegate;
}
...
- (void)longPressGestureRecognizerTriggerd:(UILongPressGestureRecognizer *)longPress
{
    switch (longPress.state) {
        ...
        case UIGestureRecognizerStateBegan:
        {
            ...
            YZAddImageCollectionViewCell *sourceCell = (YZAddImageCollectionViewCell *)sourceCollectionViewCell;
