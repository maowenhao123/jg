...
@interface YZSegementFlowLayout () <UIGestureRecognizerDelegate>

@property (nonatomic,readonly) id<YZSegementDataSource> dataSource;
@property (nonatomic,readonly) id<YZSegementDelegateFlowLayout> delegate;

@end

@implementation YZSegementFlowLayout
{
...
- (id<YZSegementDataSource>)dataSource
{
    return (id<YZSegementDataSource>)self.collectionView.dataSource;
}

- (id<YZSegementDelegateFlowLayout>)delegate
{
    return (id<YZSegementDelegateFlowLayout>)self.collectionView.delegate;
}
...
- (void)longPressGestureRecognizerTriggerd:(UILongPressGestureRecognizer *)longPress
{
    switch (longPress.state) {
        ...
        case UIGestureRecognizerStateBegan:
        {
            ...
            YZSegementCollectionViewCell *sourceCell = (YZSegementCollectionViewCell *)sourceCollectionViewCell;
