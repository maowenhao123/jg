...
@interface YZSegementFlowLayout : UICollectionViewFlowLayout

@property (nonatomic,assign) BOOL panGestureRecognizerEnable;

@end

@protocol YZSegementDataSource <UICollectionViewDataSource>
...
@protocol YZSegementDelegateFlowLayout <UICollectionViewDelegateFlowLayout>
